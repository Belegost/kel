 ...
 */
final class Version20210427171812 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX optionId_INDEX ON accounts_settings');
        $this->addSql('DROP INDEX setting_id_INDEX ON accounts_settings');
        $this->addSql('DROP INDEX userId_INDEX ON accounts_settings');
        ...
        $this->addSql('DROP INDEX typeId_INDEX ON setting_options');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX optionId_INDEX ON accounts_settings (setting_id)');
        $this->addSql('CREATE INDEX setting_id_INDEX ON accounts_settings (setting_id)');
        $this->addSql('CREATE INDEX userId_INDEX ON accounts_settings (account_id)');
        ...
        $this->addSql('CREATE INDEX typeId_INDEX ON setting_options (type_id)');
